...
PATH_TO_MASKED_SENTENCES_AMRS_WITH_BELIEF_ARGUMENT = ((Path(__file__).parent) /
                                                      "tmp/masked_sentences_with_AMR_container_objects_with_belief_argument.joblib").absolute()
