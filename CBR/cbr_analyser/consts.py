...
PATH_TO_MASKED_SENTENCES_AMRS_TRAIN_WITH_SEGMENTS = ((Path(__file__).parent) /
                                                            "tmp/masked_sentences_with_AMR_container_objects_train_with_segments.joblib").absolute()

PATH_TO_MASKED_SENTENCES_AMRS_DEV_WITH_SEGMENTS = ((Path(__file__).parent) /
                                                          "tmp/masked_sentences_with_AMR_container_objects_dev_with_segments.joblib").absolute()

PATH_TO_MASKED_SENTENCES_AMRS_TEST_WITH_SEGMENTS = ((Path(__file__).parent) /
                                                           "tmp/masked_sentences_with_AMR_container_objects_test_with_segments.joblib").absolute()
