#!/bin/bash
#SBATCH --job-name=test_curriculum_learning
...
python test_metrics.py --model_path="curriculum_learning_training/fine_training/electra/checkpoint-970" --tokenizer="howey/electra-base-mnli"
